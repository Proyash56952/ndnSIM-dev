...
#ifndef NDN_LTE_UE_NET_DEVICE_TRANSPORT_HPP
#define NDN_LTE_UE_NET_DEVICE_TRANSPORT_HPP
 ...
 */
class LteUeNetDeviceTransport : public nfd::face::Transport
{
public:
  LteUeNetDeviceTransport(Ptr<Node> node, const Ptr<NetDevice>& netDevice,
...
#endif // NDN_LTE_UE_NET_DEVICE_TRANSPORT_HPP
