...
#ifndef CCNX_UDP_Packet_TRACER_H
#define CCNX_UDP_Packet_TRACER_H
 ...
 */
class UdpPacketTracer : public SimpleRefCount<UdpPacketTracer> {
public:
  /**
   ...
   */
  UdpPacketTracer(shared_ptr<std::ostream> os, Ptr<Node> node);
   ...
   */
  UdpPacketTracer(shared_ptr<std::ostream> os, const std::string& node);
...
private:
  ...
  void
  RxWithInfo(uint32_t n, ns3::Vector v, double t);
